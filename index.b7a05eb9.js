...
const swap = _utils.loadAudio('swap');
const SIZE = 8;
const field = document.getElementById('field');
const score = document.getElementById('score');
const time = document.getElementById('time');
const popHtml = document.getElementById('pop');
const swapHtml = document.getElementById('swap');
const multiplierElement = document.getElementById('multiplier');
const playAudioElement = (name)=>{
    const url = _utils.getAudioUrl(name);
    if (!url) return;
    popHtml.playbackRate = 0.5;
    return _utils.playAudio(name === 'pop' ? popHtml : swapHtml);
};
...
window.addEventListener('resize', function(event) {
    if (!field) return;
    const tileSize = (window.innerWidth - 20) / board.size;
...
var _playAudio = require("./playAudio");
parcelHelpers.exportAll(_playAudio, exports);

},{"./delay":"2Zg7V","./loadAudio":"7iVOx","./playAudio":"4k5gG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Zg7V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "getAudioUrl", ()=>getAudioUrl
);
const GAME_AUDIO_URLS = new Map([
    [
        'pop',
        new URL(require("c634f38097e441e2"))
    ],
    [
        'swap',
        new URL(require("b10db55713d86307"))
    ], 
]);
...
const getAudioUrl = (name)=>{
    return GAME_AUDIO_URLS.get(name)?.toString();
};

},{"c634f38097e441e2":"h3E1c","b10db55713d86307":"fmzS3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h3E1c":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('aNMIV') + "pop.02626b73.mp3" + "?" + Date.now();
...
},{}],"fmzS3":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('aNMIV') + "swap.6283c80b.mp3" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"4k5gG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const playAudio = async (audio)=>{
    await audio.play();
    await _delay.delay(audio.duration * 1500);
};

},{"./delay":"2Zg7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lpcHr","jeorp"], "jeorp", "parcelRequiree4df")
